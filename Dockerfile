...
RUN echo "Preparing PyCharm Pro ${PYCHARM_BUILD} ..." \
  && if [ "$TARGETARCH" = "arm64" ]; then export pycharm_arch='-aarch64'; else export pycharm_arch=''; fi \
  && export pycharm_source=https://download.jetbrains.com/python/pycharm-professional-${PYCHARM_BUILD}${pycharm_arch}.tar.gz \
